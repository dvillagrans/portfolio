  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        >
          {t.hero.title1} <br />
          <span className="font-serif italic text-offwhite/80">{t.hero.title2}</span>
        </h1>

        <p
          ref={sublineRef}
          className="mt-6 md:mt-8 max-w-2xl font-mono text-base leading-relaxed text-offwhite/70 selection:text-offwhite selection:bg-accent"
        >
          {t.hero.subtitle1} <br />
          {t.hero.subtitle2}
        </p>
        ...
        <a
          ref={actionRef}
          href="#projects"
          className="group mt-10 md:mt-14 inline-flex items-center justify-center sm:justify-start w-full sm:w-auto min-h-[44px] gap-3 border border-offwhite/20 px-6 py-4 md:px-8 font-mono text-xs uppercase tracking-widest text-offwhite transition-all hover:bg-offwhite hover:text-charcoal active:scale-[0.98]"
        >
          {t.hero.cta}
