...
export const en: LanguageDict = { ...sharedEn, timeup: timeupEn, eyenet: eyenetEn, covidPerfiles: covidEn, cvBuilder: cvBuilderEn };
export const es: LanguageDict = { ...sharedEs, timeup: timeupEs, eyenet: eyenetEs, covidPerfiles: covidEs, cvBuilder: cvBuilderEs };
