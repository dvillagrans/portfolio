...
export const covidEn = {
  ...
  eyebrow: "Research · Public health analytics",
  title: "COVID-19 Risk Profiles",
  subtitle:
    "Risk profiling from 30M+ open Mexican health records using K-Means and Fuzzy C-Means. Advanced Data Analytics, ESCOM-IPN.",
  metrics: [
    { value: "30M+", label: "Records analyzed" },
    { value: "9", label: "Risk profiles" },
    { value: "2", label: "FCM risk groups" },
    { value: "17", label: "Clustering variables" },
  ],
  tldr: {
  ...
  pipeline: {
    title1: "Pipeline",
    title2: "From raw records to dashboard.",
  ...
  architecture: {
    ...
    d1: { nav: "Algorithms", title: "K-Means and FCM (not just one)", desc: "We needed both clear classification for triage and identification of borderline cases. ", bold: "K-Means for definitive assignment and efficiency", desc2: " on millions of records; FCM for mixed profiles and prioritization via partial memberships.", costTitle: "Trade-off", costDesc: "More clusters give more detail but more complexity to communicate; we chose k=9 and c=2." },
    d2: { nav: "Sampling", title: "Stratified sampling", desc: "Given size (30M+ records) and memory/time limits, we used ", bold: "stratified sampling", desc2: " to preserve representativeness without collapsing the pipeline.", costTitle: "Trade-off", costDesc: "Full-dataset clustering was not feasible; sample size and strata were documented." },
    d3: { nav: "Visualization", title: "PCA only for visualization", desc: "We trained clustering on ", bold: "17 standardized variables", desc2: " and used PCA only to reduce dimension in plots, not as clustering space.", costTitle: "Trade-off", costDesc: "Keeps interpretability in original feature space; visuals in 2D." },
    d4: { nav: "Delivery", title: "Portfolio in Next.js", desc: "Results had to reach ", bold: "non-technical audiences and faculty", desc2: ". We added a web layer (Next.js, React, Recharts) alongside the LaTeX report: narrative, gallery, and interactive charts.", costTitle: "Trade-off", costDesc: "Static exports; no live connection to models." }
  },
  lessons: {
  ...
  footer: {
    cta: "Need interpretable analytics from messy public data?",
    contact: "Get in touch",
    note: "Academic deliverable — ESCOM-IPN",
  },
} satisfies CovidDict;

export const covidEs = {
  back: "Volver a proyectos",
  eyebrow: "Investigación · Analítica de salud pública",
  title: "Perfiles de riesgo COVID-19",
  subtitle:
    "Perfiles de riesgo a partir de 30M+ registros abiertos mexicanos con K-Means y Fuzzy C-Means. Analítica Avanzada de Datos, ESCOM-IPN.",
  metrics: [
    { value: "30M+", label: "Registros analizados" },
    { value: "9", label: "Perfiles de riesgo" },
    { value: "2", label: "Grupos FCM" },
    { value: "17", label: "Variables clustering" },
  ],
  tldr: {
  ...
  pipeline: {
    title1: "Pipeline",
    title2: "De registros crudos al dashboard.",
  ...
  architecture: {
    ...
    d1: { nav: "Algoritmos", title: "K-Means y FCM (y no solo uno)", desc: "Hacía falta clasificación clara para triage e identificación de casos fronterizos. ", bold: "K-Means para asignación definitiva y eficiencia", desc2: " sobre millones de registros; FCM para perfiles mixtos y priorización por pertenencias parciales.", costTitle: "Trade-off", costDesc: "Más clusters dan más detalle pero más complejidad al comunicar; elegimos k=9 y c=2." },
    d2: { nav: "Muestreo", title: "Muestreo estratificado", desc: "Dado el tamaño (30M+ registros) y límites de memoria y tiempo, usamos ", bold: "muestreo estratificado", desc2: " para mantener representatividad sin colapsar el pipeline.", costTitle: "Trade-off", costDesc: "Clustering sobre el dataset completo no era viable; tamaño y estratos quedaron documentados." },
    d3: { nav: "Visualización", title: "PCA solo para visualización", desc: "Entrenamos el clustering con ", bold: "17 variables estandarizadas", desc2: " y usamos PCA solo para reducir dimensión en gráficos, no como espacio de clustering.", costTitle: "Trade-off", costDesc: "Interpretabilidad en el espacio original; visuales en 2D." },
    d4: { nav: "Entrega", title: "Portfolio en Next.js", desc: "Los resultados debían llegar a ", bold: "no técnicos y profesorado", desc2: ". Añadimos capa web (Next.js, React, Recharts) además del reporte LaTeX: narrativa, galería y gráficos interactivos.", costTitle: "Trade-off", costDesc: "Exportaciones estáticas; sin conexión en vivo a modelos." }
  },
  lessons: {
  ...
  footer: {
    cta: "¿Necesitas analítica interpretable desde datos públicos complejos?",
    contact: "Escríbeme",
    note: "Entregable académico — ESCOM-IPN",
  },
} satisfies CovidDict;
